            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold text-[var(--text-secondary)] bg-slate-50 border border-slate-200/60 uppercase tracking-wider">
                    via {review.source === 'google' ? 'Google' : 'Yelp'}
                  </span>
                </div>

                <p className="text-xs sm:text-sm text-[var(--text-secondary)] leading-relaxed mb-6 italic">
