...
export function SalesRepLeaderboardTab({ dateRange }: { dateRange?: string }) {
  ...
  return (
    <div className="space-y-4 select-none">
      ...
      {reps.length === 0 ? (
        <div className="bg-white/80 light-glass-panel rounded-3xl border border-white/90 shadow-sm p-8 text-center text-xs text-slate-400 font-medium">
                  ...
                  >
                    <td className="py-3 px-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-slate-400 capitalize">({rep.role})</span>
                      </div>
                    </td>
