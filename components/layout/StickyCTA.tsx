...
export function StickyCTA() {
  return (
    <div className="fixed bottom-3 inset-x-3 z-40 md:hidden pointer-events-none">
      <div className="glass-nav-surface rounded-2xl p-2 flex items-center gap-2 shadow-2xl border border-white/25 pointer-events-auto backdrop-blur-2xl">
        <a
          href={PHONE_HREF}
          className="flex-1 inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold text-xs uppercase tracking-wider py-3 rounded-xl transition-all"
        >
